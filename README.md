...
| --------------------------------- | :---: | :---: | :---: |
| Query Language                    | Kibana Query Language (close to Lucene syntax) | Close to Lucene syntax                                                                                                                                          | [LogQL](https://github.com/grafana/loki/blob/master/docs/logql.md)                                                                |
| Fuzzy Search                      | ![(tick)](images/check.svg) <br>(Levenshtein distance)                                  | ![(tick)](images/check.svg) <br> (Damerau–Levenshtein distance) | ![(error)](images/error.svg) |
...
| Transform message at display time | ![(error)](images/error.svg)                                                        | ![(tick)](images/check.svg) <br> (Decorators)                   | ![(error)](images/error.svg) |
| Dashboards                        | ![(tick)](images/check.svg)                                                         | ![(tick)](images/check.svg)                                | ![(tick)](images/check.svg)  |
| Alerts                            | ![(tick)](images/check.svg) <br> ([Yelp/elastalert](https://github.com/Yelp/elastalert)) | ![(tick)](images/check.svg)                                | ![(error)](images/error.svg) |
